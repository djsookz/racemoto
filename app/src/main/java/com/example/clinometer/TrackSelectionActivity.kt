...
class TrackSelectionActivity : AppCompatActivity() {
    ...
    private val officialTracks = listOf(
        OfficialTrack("serres_circuit", "Serres Circuit", "3.2km • 12 завоя • Гърция", 
            "Професионална писта за мотоциклети и автомобили с 4 timing точки за прецизни измервания.")
    )
    
    private var customTracks = mutableListOf<CustomTrack>()
    
    data class OfficialTrack(
        val id: String,
        val name: String,
        val details: String,
