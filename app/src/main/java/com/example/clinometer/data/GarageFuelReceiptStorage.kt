...
object GarageFuelReceiptStorage {
    private const val RECEIPTS_DIR = "fuel_receipts"
    private const val TEMP_DIR = "$RECEIPTS_DIR/temp"
    ...
    fun saveTempReceipt(context: Context, uri: Uri, profileId: Long, entryId: Long): String? {
        ...
        val relativePath = "$TEMP_DIR/profile_${profileId}_entry_${entryId}_${System.currentTimeMillis()}.jpg"
    ...
    fun promoteTempReceipt(context: Context, relativePath: String, profileId: Long, entryId: Long): String? {
        ...
        val finalRelativePath = "$RECEIPTS_DIR/profile_${profileId}_entry_${entryId}.jpg"
