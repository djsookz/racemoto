...
class CustomTrackBuilderActivity : AppCompatActivity() {
    ...
    private val gateAnnotationIndexById = mutableMapOf<Long, Int>()
    private var startAnnotationId: Long? = null
    private var finishAnnotationId: Long? = null
    ...
    private fun setupMap() {
        ...
        pointManager.addDragListener(object : OnPointAnnotationDragListener {
            override fun onAnnotationDragStarted(annotation: PointAnnotation) {
                handleAnnotationDragged(annotation)
            }
    ...
    private fun redrawPolylines() {
        ...
        if (checkpointPoints.size >= 2) {
            polylineManager.create(
                PolylineAnnotationOptions()
                    .withPoints(checkpointPoints)
                    .withLineColor("#0EA5E9")
                    .withLineWidth(4.0)
            )
        }
    }
