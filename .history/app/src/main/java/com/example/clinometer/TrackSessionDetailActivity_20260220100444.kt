...
class TrackSessionDetailActivity : AppCompatActivity() {
    ...
    private fun loadSessionData() {
        ...
        // Update title
        findViewById<TextView>(R.id.tvTitle).text = getString(R.string.track_session_title, outingNumber)
        ...
        tvTotalLaps.text = totalLaps.toString()
