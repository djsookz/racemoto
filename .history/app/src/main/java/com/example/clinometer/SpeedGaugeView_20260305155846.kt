...
class SpeedGaugeView @JvmOverloads constructor(
    ...
    private fun drawMotoTelemetry(canvas: Canvas) {
        ...
        textPaint.textSize = dp(10f)
        textPaint.color = Color.parseColor("#FF4E6F")
        canvas.drawText("BRAKING", leftGroupLeft + dp(38f), top + dp(51f), textPaint)

        textPaint.typeface = Typeface.create(Typeface.DEFAULT, Typeface.BOLD)
        textPaint.textSize = dp(30f)
        textPaint.color = Color.parseColor("#FF4E6F")
        canvas.drawText(String.format("%.1f", brakingG), leftGroupLeft + dp(72f), top + dp(74f), textPaint)
        textPaint.typeface = Typeface.create(Typeface.DEFAULT, Typeface.NORMAL)
        textPaint.textSize = dp(11f)
        textPaint.color = Color.parseColor("#6E88A4")
        canvas.drawText("g", leftGroupLeft + dp(116f), top + dp(74f), textPaint)
        ...
        textPaint.textSize = dp(10f)
        textPaint.color = Color.parseColor("#00E985")
        canvas.drawText("ACCEL", rightGroupLeft + dp(8f), top + dp(51f), textPaint)

        textPaint.typeface = Typeface.create(Typeface.DEFAULT, Typeface.BOLD)
        textPaint.textSize = dp(30f)
        textPaint.color = Color.parseColor("#00E985")
        canvas.drawText(String.format("%.1f", accelG), rightGroupLeft + dp(64f), top + dp(74f), textPaint)
        textPaint.typeface = Typeface.create(Typeface.DEFAULT, Typeface.NORMAL)
        textPaint.textSize = dp(11f)
        textPaint.color = Color.parseColor("#6E88A4")
        canvas.drawText("g", rightGroupLeft + dp(106f), top + dp(74f), textPaint)
