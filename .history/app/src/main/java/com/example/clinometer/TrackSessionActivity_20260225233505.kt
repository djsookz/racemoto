...
class TrackSessionActivity : BaseActivity(), SensorEventListener, LocationListener {
    ...
    private fun processLinearAccelerationAndUpdate(deviceAccel: FloatArray) {
        ...
        val corneringLeftG = max(0f, currentGForceX)
        val corneringRightG = max(0f, -currentGForceX)
        ...
        maxCorneringLeftG = max(maxCorneringLeftG, corneringLeftG)
        maxCorneringRightG = max(maxCorneringRightG, corneringRightG)
