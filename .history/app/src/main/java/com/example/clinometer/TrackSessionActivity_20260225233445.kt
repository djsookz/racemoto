...
class TrackSessionActivity : BaseActivity(), SensorEventListener, LocationListener {
    ...
    private fun updateStatistics() {
        ...
        // gForceX > 0 = force to the right (typically left turn), gForceX < 0 = force to the left (typically right turn)
        maxCorneringLeftG = max(maxCorneringLeftG, max(0f, gForceX))
        maxCorneringRightG = max(maxCorneringRightG, max(0f, -gForceX))
