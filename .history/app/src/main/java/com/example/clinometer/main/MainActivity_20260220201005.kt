...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    private fun setupMapboxMap() {
        ...
        mapboxMapView?.let { mapView ->
            MapInitialCameraApplier.apply(
                ...
                calculateBearingBetweenPoints = ::calculateBearingBetweenPoints,
    ...
    private fun createOrangeTopImage(): Bitmap {
        return NavigationMarkerImageFactory.createOrangeTopImage(resources.displayMetrics.density)
    }

    private fun createOrangeBearingImage(): Bitmap {
        return NavigationMarkerImageFactory.createOrangeBearingImage(resources.displayMetrics.density)
    }

    private fun createOrangeShadowImage(): Bitmap {
        return NavigationMarkerImageFactory.createOrangeShadowImage(resources.displayMetrics.density)
    }
    
    private fun calculateBearingBetweenPoints(lat1: Double, lon1: Double, lat2: Double, lon2: Double): Double {
        return GeoBearing.calculateBetweenPoints(lat1, lon1, lat2, lon2)
    }
