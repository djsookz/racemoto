    ...
    private fun saveOriginalRoute() {
        ...
        if (routePoints.size > 1) {
            for (i in 0 until routePoints.size - 1) {
                ...
                val color = when {
                    startPoint.speed < 2f -> Color.rgb(139, 0, 0)
                    accelRatio > 0.66f -> Color.rgb(0, 128, 0)
                    accelRatio > 0.33f -> Color.rgb(0, 200, 0)
                    accelRatio > 0 -> Color.rgb(154, 205, 50)
                    accelRatio == 0f -> Color.rgb(255, 255, 0)
                    accelRatio > -0.5f -> Color.rgb(255, 165, 0)
                    else -> {
