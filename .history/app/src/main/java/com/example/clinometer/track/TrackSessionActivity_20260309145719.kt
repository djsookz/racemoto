...
class TrackSessionActivity : BaseActivity(), SensorEventListener, LocationListener {
    ...
    private fun configureTelemetryProfileUi() {
        ...
        val showCircularGauge = !isMotorcycle

        gGaugeTrack.visibility = if (showCircularGauge) View.VISIBLE else View.GONE
        ...
        if (isMotorcycle) {
            ...
            tvMotoGHeader.text = "G-FORCE - LONG / LAT"
    ...
    private fun updateMotoGForceCard() {
        ...
        if (isMotorcycle) {
            ...
            tvMotoMaxBrakingValue.text = String.format(Locale.US, "%.1fg", leftX)
            tvMotoMaxAccelValue.text = String.format(Locale.US, "%.1fg", rightX)
            val resultG = sqrt(currentLongitudinalG * currentLongitudinalG + currentLateralG * currentLateralG)
            tvMotoTotalValue.text = String.format(Locale.US, "%.1f", resultG)
            gGaugeTrack.gForceX = currentLateralG
            gGaugeTrack.gForceY = currentLongitudinalG
        }
