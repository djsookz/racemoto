...
class TrackSessionActivity : BaseActivity(), SensorEventListener, LocationListener {
    ...
    private val carResultPeakDetector = PeakDetector()
    ...
    private fun updateSessionGForceStatistics(rawLatG: Float, rawLongG: Float, confidence: Float) {
        ...
        val resultSample = sqrt(lateral * lateral + longitudinal * longitudinal)
        maxCarResultG = updatePeakDetector(carResultPeakDetector, resultSample, nowMs)
    }
