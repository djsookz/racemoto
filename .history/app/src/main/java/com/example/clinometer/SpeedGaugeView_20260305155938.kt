...
class SpeedGaugeView @JvmOverloads constructor(
    ...
    private fun drawMotoTelemetry(canvas: Canvas) {
        ...
        canvas.drawRect(leftGroupLeft, top + dp(56f), leftGroupLeft + dp(8f), top + dp(64f), fillPaint)

        textPaint.textAlign = Paint.Align.LEFT
        textPaint.typeface = Typeface.create(Typeface.DEFAULT, Typeface.BOLD)
        textPaint.textSize = dp(8.5f)
        textPaint.color = Color.parseColor("#FF4E6F")
        canvas.drawText("BRAKING", leftGroupLeft + dp(38f), top + dp(63f), textPaint)
        ...
        fillPaint.color = Color.parseColor("#59667A")
        canvas.drawRect(rightGroupLeft, top + dp(56f), rightGroupLeft + dp(8f), top + dp(64f), fillPaint)

        textPaint.textAlign = Paint.Align.LEFT
        textPaint.typeface = Typeface.create(Typeface.DEFAULT, Typeface.BOLD)
        textPaint.textSize = dp(8.5f)
        textPaint.color = Color.parseColor("#00E985")
        canvas.drawText("ACCEL", rightGroupLeft + dp(8f), top + dp(63f), textPaint)
