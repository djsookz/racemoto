...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    private fun resolveRouteGeometryJsonFromIntent(intent: Intent): String? {
    ...
    private fun resolveDirectionsResponseJsonFromIntent(intent: Intent): String? {
        ...
        return if (directionsResponseInCache) {
            try {
                NavigationDataCache.loadDirectionsResponse(this)
            } catch (e: Exception) {
    ...
    private fun connectServiceForCurrentLaunchMode() {
        when {
            isServiceRunning() -> bindToRunningForegroundService()
            isNavigationActive -> startAndBindNavigationService()
        }
    }
    ...
    private fun initializeNavigationStateFromIntent(intent: Intent) {
        ...
        val routeGeometryJson = resolveRouteGeometryJsonFromIntent(intent)
        directionsResponseJson = resolveDirectionsResponseJsonFromIntent(intent)
        ...
        directionsResponseJson?.let { json ->
            navigationSteps = DirectionsResponseParser.extractSteps(json)
        }
    ...
    private fun initializeCurrentProfile(intent: Intent) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initializeCurrentProfile(intent)
        ...
        connectServiceForCurrentLaunchMode()
