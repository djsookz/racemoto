...
class TrackSessionActivity : BaseActivity(), SensorEventListener, LocationListener {
    ...
    private fun handlePointToPointStagingAndStart(location: Location, startLineA: TrackPoint, startLineB: TrackPoint) {
        ...
        updatePointToPointStartDialog(distanceToStartLine)
    ...
    private fun updatePointToPointStartDialog(distanceToStartLineMeters: Double) {
        ...
        val message = if (distanceToStartLineMeters <= pointToPointStartHintMeters) {
            "До старта: ${meters} m\nКогато пресечеш старт линията, измерването започва."
        } else {
            "Приближи се до старт линията, за да започне състезанието.\nКогато я пресечеш, измерването започва."
        }
    ...
    private fun showAwaitingStartDialog() {
        val message = if (currentTrackMode == TrackMode.POINT_TO_POINT) {
            "Приближи се до старт линията. Когато я пресечеш, измерването започва."
        } else {
