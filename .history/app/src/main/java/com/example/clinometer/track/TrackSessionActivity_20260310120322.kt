...
class TrackSessionActivity : BaseActivity(), SensorEventListener, LocationListener {
    ...
    private var lastTelemetryUiUpdateNs: Long = 0L
    private val telemetryUiMinIntervalNs: Long = 20_000_000L
    ...
    private fun maybeUpdateTelemetryUi() {
        val nowNs = SystemClock.elapsedRealtimeNanos()
        if (nowNs - lastTelemetryUiUpdateNs < telemetryUiMinIntervalNs) return
