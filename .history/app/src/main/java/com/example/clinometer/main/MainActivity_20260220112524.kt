...
import com.example.clinometer.main.navigation.ManeuverFormatter
...
class MainActivity : AppCompatActivity(), SensorEventListener {
    ...
    private fun recalculateTotalDistance() {
        distanceTracker.recalculateTotalDistance()
    }
    ...
    private fun updateCurrentNavigationStep(currentLocation: GeoPoint) {
        ...
        if (currentStepIndex < navigationSteps.size) {
            val currentStep = navigationSteps[currentStepIndex]
            val distanceToManeuver = RouteMath.calculateDistanceToManeuver(currentLocation, currentStep)
    ...
    private fun updateManeuverView(stepIndex: Int, distanceToManeuver: Double = -1.0) {
        ...
        tvManeuverDistance?.text = RouteMath.formatDistance(distance)
        ...
        val formattedInstruction = ManeuverFormatter.formatManeuverInstruction(this, instruction)
        ...
        for (stepIndex in 0 until navigationSteps.size) {
            ...
            try {
                ...
                for (i in approachGeometry.size - 1 downTo 1) {
                    ...
                    val segmentDist = RouteMath.haversineDistance(p1[1], p1[0], p2[1], p2[0])
