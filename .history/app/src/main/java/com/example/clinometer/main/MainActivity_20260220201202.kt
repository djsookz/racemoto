        ...
        mv.location.apply {
            ...
            updateSettings {
                ...
                locationPuck = LocationPuck2D(
                    topImage = ImageHolder.from(NavigationMarkerImageFactory.createOrangeTopImage(resources.displayMetrics.density)),
                    bearingImage = ImageHolder.from(NavigationMarkerImageFactory.createOrangeBearingImage(resources.displayMetrics.density)),
                    shadowImage = ImageHolder.from(NavigationMarkerImageFactory.createOrangeShadowImage(resources.displayMetrics.density))
                )
            }
        }
