...
class LeanVisualizerView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val topInset = heightF * 0.01f
        val bottomInset = heightF * 0.01f
        val groundY = heightF - bottomInset
        val radiusByHeight = (groundY - topInset) / 1.12f
        val radius = min(widthF * 0.50f, radiusByHeight)

        canvas.drawLine(widthF * 0.05f, groundY, widthF * 0.95f, groundY, groundPaint)
        ...
        val rearDist = radius * 0.26f
        val frontDist = radius * 0.90f
        ...
        val rearRadius = radius * 0.24f
        val frontRadius = radius * 0.23f
        ...
        val riderHalfW = radius * 0.08f
        val riderHalfH = radius * 0.15f
        canvas.drawOval(
        ...
        canvas.drawCircle(helmetX, helmetY, radius * 0.10f, riderStrokePaint)
    }
