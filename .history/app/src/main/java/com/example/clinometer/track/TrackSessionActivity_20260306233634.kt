...
class TrackSessionActivity : BaseActivity(), SensorEventListener, LocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        reloadLeanCalibrationForProfile(currentProfileId)
    ...
    private fun reloadLeanCalibrationForProfile(profileId: Long) {
            ...
            when (ev.sensor.type) {
                ...
                Sensor.TYPE_GYROSCOPE -> {
                    ...
                    if (hasGyroIntegratedLean) {
                        val dtSec = ((ev.timestamp - gyroTimestampNs) / 1_000_000_000f).coerceIn(0f, 0.06f)
                        if (dtSec > 0f) {
