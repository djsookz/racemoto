...
class SettingsFragment : Fragment() {
    ...
    private fun updateVehicleSpecificCards() {
        // Reset-v2: използваме единна calibration логика и runtime zeroing за lean,
        // затова отделната Lean Calibration страница е временно скрита.
        cardLeanCalibration.visibility = View.GONE
        dividerLeanCalibration.visibility = View.GONE
    }
