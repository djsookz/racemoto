...
class TrackSessionActivity : BaseActivity(), SensorEventListener, LocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val hasTrackIntentVehicleMode = intent.hasExtra(TrackMapExtras.EXTRA_TRACK_IS_MOTORCYCLE)
        val intentIsMotorcycle = intent.getBooleanExtra("is_motorcycle", true)
        val trackIntentIsMotorcycle = intent.getBooleanExtra(TrackMapExtras.EXTRA_TRACK_IS_MOTORCYCLE, true)
        ...
        if (hasIntentVehicleMode && hasProfileVehicleType && intentIsMotorcycle != profileIsMotorcycle) {
            Log.w(
                "TrackSessionActivity",
                "Mismatched vehicle mode (intent=$intentIsMotorcycle, profile=$profileIsMotorcycle); using intent mode"
            )
        }
