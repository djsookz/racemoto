...
class TrackSessionActivity : BaseActivity(), SensorEventListener, LocationListener {
    ...
    private fun initializeViews() {
        ...
        motoGForceContainer.visibility = if (isMotorcycle) View.VISIBLE else View.GONE
        speedGauge.visibility = if (isMotorcycle) View.GONE else View.VISIBLE
        loadTrackBestLapReference()
        applyPredictiveGapSourceUi()
        resetPredictiveGapCard()
        speedGauge.setMotorcycleMode(false)
    ...
    private fun updateMotoGForceCard() {
        ...
        rlMotoAxis.post {
            ...
            val normalized = (currentLongitudinalG / 2.5f).coerceIn(-1f, 1f)
    ...
    private fun updateGauge() {
        ...
        if (
            ...
            val remainingDistance = (referenceDistanceMeters - lapDistanceAccum).coerceAtLeast(0f)
